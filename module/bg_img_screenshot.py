...
def is_mostly_black(image, sample_points=9):
    ...
    # 定义要检查的像素位置
    positions = [(0, 0),
                 (0, width - 1 if width != 0 else 0),
                 (height - 1 if height != 0 else 0, 0),
                 (height - 1 if height != 0 else 0, width - 1 if width != 0 else 0),
                 (height // 2, width // 2),
                 (0, width // 2),
                 (height // 2, 0),
                 (height - 1 if height != 0 else 0, width // 2),
                 (height // 2, width - 1 if width != 0 else 0)
                 ]
